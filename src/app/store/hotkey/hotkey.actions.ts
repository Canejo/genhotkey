...
export const listHotkey = createAction('[Hotkey] List', props<{ payload?: Hotkey }>());
...
export const salvarHotkeySuccess = createAction('[Hotkey] Salvar hotkey Success', props<{ payload: Hotkey }>());
